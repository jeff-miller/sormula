This is a stand-alone example to demonstrate basic Sormula features. Everything
...
QuantityRangeSelect.java      Custom query source class
readme.txt                    This file
run.bat                       Executes java to run example
simpleDB.properties           Example database 
...
sormula-1.0.5.jar             Sormumla api