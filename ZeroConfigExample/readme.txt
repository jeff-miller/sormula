This is a stand-alone example to demonstrate using sormula with
nothing but a POJO and the sormula.jar. Everything needed to run 
this example is in the directory with this file. The only 
requirement is a JDK to compile and run.
