...
import org.sormula.builder.DatabaseBuilder;
...
public class Database implements TypeTranslatorMap, AutoCloseable
{
     ...
     */
    public static DatabaseBuilder builder(DataSource dataSource)
    {
        return new DatabaseBuilder(dataSource);
    }
     ...
     */
    public static DatabaseBuilder builder(String dataSourceName)
    {
        return new DatabaseBuilder(dataSourceName);
    }
     ...
     */
    public static DatabaseBuilder builder(Connection connection)
    {
        return new DatabaseBuilder(connection);
    }
    ...
    public <R> Table<R> getTable(Class<R> rowClass, boolean create) throws SormulaException
    {
        ...
        {
            // first request for table of rowClass and create is requested
