...
public class Table<R> implements TypeTranslatorMap, TransactionListener
{
    ...
    {
        return new InsertOperation<R>(this, autoGeneratedKeys).insert(row);
    }
    ...
    {
        @SuppressWarnings("resource") // InsertOperation#insert performs close
        InsertOperation<R> operation = new InsertOperation<R>(this, autoGeneratedKeys);
    ...
    {
        if (rows.size() > 0) return new InsertOperation<R>(this, autoGeneratedKeys).insertAll(rows);
        else return 0;
    }
    ...
    {
        return new SaveOperation<R>(this, autoGeneratedKeys).modify(row);
    }
    ...
    public int saveBatch(R row) throws SormulaException
    {
        ...
        SaveOperation<R> operation = new SaveOperation<R>(this, autoGeneratedKeys);
        operation.setBatch(true);
    ...
    {
        if (rows.size() > 0) return new SaveOperation<R>(this, autoGeneratedKeys).modifyAll(rows);
        else return 0;
    }
