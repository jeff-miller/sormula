...
public class Table<R> implements TypeTranslatorMap, TransactionListener
{
    ...
    {
        try (ArrayListSelectOperation<R> operation = new ArrayListSelectOperation<>(this, ""))
        {
            if (rowAnnotation != null)
            {
    ...
    {
        try (ArrayListSelectOperation<R> operation = new ArrayListSelectOperation<>(this, whereConditionName))
        {
    ...
    {
        try (InsertOperation<R> insertOperation = new InsertOperation<>(this, autoGeneratedKeys))
        {
            return insertOperation.insert(row);
        }
    }
    ...
    {
        try (InsertOperation<R> operation = new InsertOperation<>(this, autoGeneratedKeys))
        {
    ...
    public int insertAll(Collection<R> rows) throws SormulaException
    {
        if (rows.size() > 0)
        {
            try (InsertOperation<R> insertOperation = new InsertOperation<>(this, autoGeneratedKeys))
            {
                return insertOperation.insertAll(rows);
            }
        }
        else
        {
    ...
    {
        try (UpdateOperation<R> updateOperation = new UpdateOperation<>(this))
        {
            return updateOperation.update(row);
        }
    }
    ...
    {
        try (UpdateOperation<R> operation = new UpdateOperation<>(this))
        {
            operation.setBatch(true);
    ...
    public int updateAll(Collection<R> rows) throws SormulaException
    {
        if (rows.size() > 0)
        {
            try (UpdateOperation<R> updateOperation = new UpdateOperation<>(this))
            {
                return updateOperation.updateAll(rows);
            }
        }
        else
        {
    ...
    {
        try (DeleteOperation<R> deleteOperation = new DeleteOperation<>(this))
        {
            return deleteOperation.delete(parameters);
        }
    }
    ...
    public int delete(R row) throws SormulaException
    {
        try (DeleteOperation<R> deleteOperation = new DeleteOperation<>(this))
        {
            return deleteOperation.delete(row);
        }
    }
    ...
    {
        try (DeleteOperation<R> operation = new DeleteOperation<>(this))
        {
            operation.setBatch(true);
    ...
    public int deleteAll(Collection<R> rows) throws SormulaException
    {
        if (rows.size() > 0)
        {
            try (DeleteOperation<R> deleteOperation = new DeleteOperation<>(this))
            {
                return deleteOperation.deleteAll(rows);
            }
        }
        else
        {
    ...
    {
        try (SaveOperation<R> saveOperation = new SaveOperation<>(this, autoGeneratedKeys))
        {
            return saveOperation.modify(row);
        }
    }
    ...
    {
        try (SaveOperation<R> operation = new SaveOperation<>(this, autoGeneratedKeys))
        {
            operation.setBatch(true);
    ...
    public int saveAll(Collection<R> rows) throws SormulaException
    {
        if (rows.size() > 0) 
        {
            try (SaveOperation<R> saveOperation = new SaveOperation<>(this, autoGeneratedKeys))
            {
                return saveOperation.modifyAll(rows);
            }
        }
        else
        {
