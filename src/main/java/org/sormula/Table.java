...
public class Table<R> implements TypeTranslatorMap, TransactionListener
{
    ...
    public static <R> Builder<R> builder(Database database, Class<R> rowClass)
    {
        return new Builder<>(database, rowClass);
    }

    
    public static class Builder<R> extends AbstractBuilder<R, Builder<R>, Table<R>>
    {
        public Builder(Database database, Class<R> rowClass) 
        {
    ...
    public static class AbstractBuilder<R, B extends AbstractBuilder, T extends Table<R>>
    {
        Database database;
        Class<R> rowClass;
        boolean autoGeneratedKeys;
        
        public AbstractBuilder(Database database, Class<R> rowClass)
        {
        ...
        public T build() throws SormulaException
        {
            @SuppressWarnings("unchecked")
            T table = (T)new Table<R>(database, rowClass);
            init(table);
            return table;
        }
     ...
     * <p>
     * Since 4.1, {@link #setAutoGeneratedKeys(boolean)} defaults to {@link Database#isAutoGeneratedKeys()}.
     * 
    ...
    public Table(Database database, Class<R> rowClass) throws SormulaException
    {
        ...
        // set read-only based upon row annotation
        if (rowAnnotation != null) readOnly = rowAnnotation.readOnly();
    ...
    /**
     * Gets the most recent value of {@link #setAutoGeneratedKeys(boolean)}. The default is 
     * {@link Database#isAutoGeneratedKeys()} at the time of construction of this {@link Table}.
     * 
    ...
    /**
     * Sets the default way identity columns are processed for operations that use this {@link Table}.
     * When autoGeneratedKeys is false, any row field annotated as true for {@link Column#identity()}
     ...
     * 
     * @param autoGeneratedKeys true if identity columns get their value as automatically generated 
     * by the database; false if database will generate the identity column 
     * 
     * @since 4.1
     * @see Column#identity()
     ...
     * 
     * @return true if modify operations are not permitted for this table
     * @since 4.2
     */
    ...
    /**
     * Sets read-only indicator. When true, modify operations using this
     * table will fail with a {@link ReadOnlyException}. 
     * By default read-only is false unless row or table class is 
     * annotated with {@link Row#readOnly()} of true. Set to true as a safe-guard
     * to prevent accidental modification of table.
     * 
    ...
    {
        // default
        return new RowTranslator<>(this, rowAnnotation);
    }
    ...
    {
        @SuppressWarnings("resource") // ArrayListSelectOperation#selectAll performs close
     ...
     * @throws SormulaException if error
     */
    @SuppressWarnings("resource") // InsertOperation#insert performs close
    public int insert(R row) throws SormulaException
    {
        return new InsertOperation<>(this, autoGeneratedKeys).insert(row);
    }
    ...
    {
        @SuppressWarnings("resource") // InsertOperation#insert performs close
        InsertOperation<R> operation = new InsertOperation<>(this, autoGeneratedKeys);
     ...
     * @throws SormulaException if error
     */
    @SuppressWarnings("resource") // InsertOperation#insertAll performs close
    public int insertAll(Collection<R> rows) throws SormulaException
    {
        if (rows.size() > 0) return new InsertOperation<>(this, autoGeneratedKeys).insertAll(rows);
        else return 0;
    }
     ...
     * @throws SormulaException if error
     */
    @SuppressWarnings("resource") // UpdateOperation#update performs close
    ...
    {
        @SuppressWarnings("resource") // UpdateOperation#update performs close
        UpdateOperation<R> operation = new UpdateOperation<>(this);
        operation.setBatch(true);
     ...
     * @throws SormulaException if error
     */
    @SuppressWarnings("resource") // UpdateOperation#updateAll performs close
    public int updateAll(Collection<R> rows) throws SormulaException
    {
        if (rows.size() > 0) return new UpdateOperation<>(this).updateAll(rows);
        else return 0;
    }
     ...
     * @throws SormulaException if error
     */
    @SuppressWarnings("resource") // DeleteOperation#delete performs close
    ...
    {
        @SuppressWarnings("resource") // DeleteOperation#delete performs close
        DeleteOperation<R> operation = new DeleteOperation<>(this);
        operation.setBatch(true);
     ...
     * @throws SormulaException if error
     */
    @SuppressWarnings("resource") // DeleteOperation#deleteAll performs close
    public int deleteAll(Collection<R> rows) throws SormulaException
    {
        if (rows.size() > 0) return new DeleteOperation<>(this).deleteAll(rows);
        else return 0;
    }
     ...
     * @throws SormulaException if error
     */
    @SuppressWarnings("resource") // SaveOperation#modify performs close
    public int save(R row) throws SormulaException
    {
        return new SaveOperation<>(this, autoGeneratedKeys).modify(row);
    }
    ...
    {
        @SuppressWarnings("resource") // SaveOperation#save performs close
        SaveOperation<R> operation = new SaveOperation<>(this, autoGeneratedKeys);
        operation.setBatch(true);
     ...
     * @throws SormulaException if error
     */
    @SuppressWarnings("resource") // SaveOperation#modifyAll performs close
    public int saveAll(Collection<R> rows) throws SormulaException
    {
        if (rows.size() > 0) return new SaveOperation<>(this, autoGeneratedKeys).modifyAll(rows);
        else return 0;
    }
    ...
    public int saveAllBatch(Collection<R> rows) throws SormulaException
    {
        if (rows.size() > 0)
        {
            @SuppressWarnings("resource") // SaveOperation#saveAll performs close
            SaveOperation<R> operation = new SaveOperation<>(this, autoGeneratedKeys);
            operation.setBatch(true);
