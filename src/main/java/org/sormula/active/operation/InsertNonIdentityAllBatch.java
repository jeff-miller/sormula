...
/**
 * Delegate for {@link Table#insertNonIdentityAllBatch(Collection)}.
 * 
 * @author Jeff Miller
 * @since 3.1
 * @param <R> record type
...
public class InsertNonIdentityAllBatch<R extends ActiveRecord<? super R>> extends ActiveOperation<R, Integer>
{
    ...
    public InsertNonIdentityAllBatch(ActiveTable<R> activeTable, Collection<R> records)
    {
    ...
    {
        attach(records);
        return getTable().insertNonIdentityAllBatch(records);
    }
}
