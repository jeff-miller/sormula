...
/**
 * Delegate for {@link Table#saveAll(Collection)}.
 * 
 * @author Jeff Miller
 * @since 1.7 and 2.1
 * @param <R> record type
 */
public class SaveAll<R extends ActiveRecord<? super R>> extends ActiveOperation<R, Integer>
{
    ...
    {
        attach(records);
        return getTable().saveAll(records);
    }
}
