...
/**
 * Delegate for {@link Table#saveNonIdentityAllBatch(Collection)}.
 * 
 * @author Jeff Miller
 * @since 4.1
...
public class SaveNonIdentityAllBatch<R extends ActiveRecord<? super R>> extends ActiveOperation<R, Integer>
{
    ...
    public SaveNonIdentityAllBatch(ActiveTable<R> activeTable, Collection<R> records)
    {
    ...
    {
        attach(records);
        return getTable().saveNonIdentityAllBatch(records);
    }
}
