...
/**
 * Delegate for {@link Table#updateBatch(Object)}
 * 
 * @author Jeff Miller
 * @since 4.1
 * @param <R> record type
 */
public class UpdateBatch<R extends ActiveRecord<? super R>> extends ActiveOperation<R, Integer>
{
    R record;
    ...
    {
        attach(record);
        return getTable().updateBatch(record);
    }
}
