...
public class TableTester extends DatabaseTest<TableTesterRow>
{
    ...
    public void builderReadOnly() throws SormulaException
    {
        ...
        table = Table.builder(database, TableTesterRow.class).readOnly(false).build();
        assert table.isReadOnly() == false : "readOnly should be false";
        
        table = Table.builder(database, TableTesterRow.class).readOnly(true).build();
    ...
    public void builderRequiredCascades() throws SormulaException
    {
        ...
        table = Table.builder(database, TableTesterRow.class).requiredCascades(required[0], required[1]).build();
    ...
    public void builderTableName() throws SormulaException
    {
        ...
        table = Table.builder(database, TableTesterRow.class).tableName(overrideTableName).build();
