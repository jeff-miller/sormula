...
public class TableBuilderTest extends DatabaseTest<TableBuilderTestRow>
{
    @BeforeClass
    public void setUp() throws Exception
    {
        ...
        createTable(TableBuilderTestRow.class, 
            "CREATE TABLE " + getSchemaPrefix() + TableBuilderTestRow.class.getSimpleName() + " (" +
    ...
    public void builderAutoGeneratedKeys() throws SormulaException
    {
        ...
        Table<TableBuilderTestRow> table;
        
        table = Table.builder(database, TableBuilderTestRow.class).build();
        assert table.isAutoGeneratedKeys() == database.isAutoGeneratedKeys() : "autoGeneratedKeys should default to database";
        
        table = Table.builder(database, TableBuilderTestRow.class).autoGeneratedKeys(false).build();
        assert table.isAutoGeneratedKeys() == false : "autoGeneratedKeys should be false";
        
        table = Table.builder(database, TableBuilderTestRow.class).autoGeneratedKeys(true).build();
    ...
    public void builderReadOnly() throws SormulaException
    {
        ...
        table = Table.builder(database, TableBuilderTestRow.class).readOnly(false).build();
        assert table.isReadOnly() == false : "readOnly should be false";
        
        table = Table.builder(database, TableBuilderTestRow.class).readOnly(true).build();
    ...
    public void builderRequiredCascades() throws SormulaException
    {
        ...
        table = Table.builder(database, TableBuilderTestRow.class).requiredCascades(required[0], required[1]).build();
    ...
    public void builderTableName() throws SormulaException
    {
        ...
        table = Table.builder(database, TableBuilderTestRow.class).tableName(overrideTableName).build();
