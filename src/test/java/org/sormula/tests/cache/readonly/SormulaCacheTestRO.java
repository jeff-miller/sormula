...
/**
 * Row class for testing {@link ReadOnlyCache}.
 * 
 * @author Jeff Miller
 */
@Cached(type=ReadOnlyCache.class)
@Where(name="type", fieldNames="type")
public class SormulaCacheTestRO
{
    ...
    public SormulaCacheTestRO()
    {
    }

    
    public SormulaCacheTestRO(int id, int type, String description)
    {
        this.id = id;
        this.type = type;
