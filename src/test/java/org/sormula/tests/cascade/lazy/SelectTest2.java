...
/**
 * Tests lazy cascade select annotations for {@link SormulaTestParentLazy2}.
 * 
 * @author Jeff Miller
 */
@Test(singleThreaded=true, groups="cascade.select", dependsOnGroups="cascade.insert")
public class SelectTest2 extends DatabaseTest<SormulaTestParentLazy2>
{
    @BeforeClass
    ...
    @Test
    public void cascadeSelectLazy2() throws Exception
    {
        begin();
