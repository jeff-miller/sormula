...
public class SormulaSymParent2 extends SormulaSymParent
{
    // tests 1 to many relationship
    @OneToManyCascade(foreignKeyValueFields="#", 
            selects=@SelectCascade(sourceParameterFieldNames="#primaryKeyFields", targetWhereName="byParent"))
    List<SormulaSymChild> childList;
    
    
    public SormulaSymParent2()
    {
    }
