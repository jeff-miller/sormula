...
public class SormulaSymParent4 extends SormulaSymParent
{
    // tests 1 to many relationship
    @OneToManyCascade(foreignKeyValueFields="#", 
            selects=@SelectCascade(sourceParameterFieldNames="#primaryKeyFields", targetWhereName="#sourceFieldNames"))
    List<SormulaSymChild> childList;
    
    
    public SormulaSymParent4()
    {
    }

    
    public SormulaSymParent4(int parentId, String description)
    {
