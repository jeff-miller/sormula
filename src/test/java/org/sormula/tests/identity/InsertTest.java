...
public class InsertTest extends DatabaseTest<IdentityTest>
{
    ...
    @Test
    public void insertOneNonIdentityBuilder() throws SormulaException
    {
        if (isTestIdentity())
        {
            begin();
            int key = 9997;
            IdentityTest row = new IdentityTest(key, "Insert one");
            Table<IdentityTest> table = Table.builder(getDatabase(), IdentityTest.class)
    ...
    @Test
    public void insertOneNonIdentity2() throws SormulaException
    {
        if (isTestIdentity())
        {
            begin();
