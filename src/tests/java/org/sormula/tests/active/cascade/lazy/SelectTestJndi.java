...
/**
 * Tests lazy cascade selects with data source obtained from JNDI.
 * 
 * @author Jeff Miller
 */
@Test(singleThreaded=true, groups="active.select", dependsOnGroups="active.insert")
public class SelectTestJndi extends ActiveDatabaseTest<SormulaTestParentLazyAR>
{
    @BeforeClass
    ...
    @Test
    public void cascadeSelectLazyArJndi() throws SormulaException
    {
