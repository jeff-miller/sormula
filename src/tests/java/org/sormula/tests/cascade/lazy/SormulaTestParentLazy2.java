 ...
 * Lazy selects work any time (even when original connection has been closed).
 * 
 * @author Jeff Miller
 */
@Row(tableName="SormulaTestParentLazy")
public class SormulaTestParentLazy2 extends DurableLazySelector<SormulaTestParentLazy2>
{
