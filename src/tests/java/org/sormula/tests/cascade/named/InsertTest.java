...
public class InsertTest extends DatabaseTest<SormulaNCTestLevel1>
{
    ...
    public void setUp() throws Exception
    {
        ...
        child2.createTable(SormulaNCTestLevel2.class, 
                ...
                " description VARCHAR(60)," +
                " FOREIGN KEY (parentid) REFERENCES " + getSchemaPrefix() + SormulaNCTestLevel1.class.getSimpleName() +"(id)" +
                ")"
            );
        ...
        child3.createTable(SormulaNCTestLevel3.class, 
                ...
                " parentid INTEGER NOT NULL," +
                " description VARCHAR(60)," +
                " FOREIGN KEY (parentid) REFERENCES " + getSchemaPrefix() + SormulaNCTestLevel2.class.getSimpleName() +"(id)" +
                ")"
            );
